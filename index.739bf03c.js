...
},{"../sass/main.scss":"dFl68","./scroll":"55W1t","./menu":"dTgwB","./slider":"aMYz0"}],"dFl68":[function() {},{}],"55W1t":[function(require,module,exports,__globalThis) {
...
},{}],"dTgwB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aMYz0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function sliderButtonHandler(button, index) {
    button.addEventListener("click", ()=>{
        ...
        slider.querySelector(`[data-index="${index}"]`).scrollIntoView({
            behavior: "smooth",
            block: "nearest"
        });
    });
...
function slideHandler(slide, index, slidesCount) {
    ...
    function dragStop() {
        ...
        if (currentX - startX < 0 && Math.abs(currentX - startX) > 100 && index + 1 < slidesCount) {
            ...
            slider.querySelector(`[data-index="${index + 1}"]`).scrollIntoView({
                behavior: "smooth",
                block: "nearest"
            });
        }
